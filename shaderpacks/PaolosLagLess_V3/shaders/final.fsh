...
Paolo's Lagless shaders, derived from Chocapic13's :D
...
#define GAMMA 1.1							//1.0 is default brightness. lower values will brighten image, higher values will darken image	
#define TONEMAP
