...
/*
'Paoloq09's shaders, derived from SonicEther v10 rc6
...
#define SHADOW_DARKNESS 0.42			//change shadow darkness , see .vsh for colors
#define SUNLIGHTAMOUNT 1.03				//change sunlight strength , see .vsh for colors
#define SHADOWDISTANCE 61.3 
#define SHADOW_CLAMP 0.5
#define SHADOW_RES 413.0

/* SHADOWRES:413 */				//affect shadow map resolution (change SHADOW_RES with it!)
/* SHADOWHPL:61.3 */				//affect shadow map draw distance (change SHADOWDISTANCE with it!)
